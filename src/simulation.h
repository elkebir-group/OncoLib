...
/// This class implements and extends an agent-based model of tumor progression
...
public:
  ...
  /// Run simulation and return number of trials
  ///
  /// @param outputDirectory Output directory
  /// @param filenameColorMap Color map filename
  /// @param seed Random number generator seed
  /// @param carryingCapacity Carrying capacity for each anatomical site
  /// @param mutFreqThreshold Mutation frequency threshold
  /// @param migrationRate Migration rate
  /// @param mutationRate Mutation
  /// @param driverRate Driver mutation probability
  /// @param maxNrAnatomicalSites Maximum number of (detectable) anatomical sites
  ...
  /// @param sequencingErrorRate Sequencing error rate
  /// @param purity Purity
  /// @param verbose Verbose
  static int run(const std::string& outputDirectory,
...
private:
  ...
  /// @param seed Random number generator seed
  static void output(const Simulation& simulation,
                     const std::string& outputDirectory,
                     const StringToIntMap& colorMap,
                     int seed);
  
  /// Return whether simulated migration graph has the desired pattern
  ///
  /// @param G Migration graph
  /// @param pattern Migration pattern
  static bool success(const MigrationGraph& G,
...
private:
  ...
  /// Number of samples per metastatic anatomical site
  const int _nrSamplesPerAnatomicalSite;
  /// Number of samples of the primary
