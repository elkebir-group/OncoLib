...
public:
  ...
  BaseMatrix(const StringVector& indexToLocation,
  ...
  /// Return index to sample vector
  const StringVector& getIndexToSamples() const
  {
    return _indexToSample;
  }
  ...
  /// Return index to character vector
  const StringVector& getIndexToCharacters() const
  {
    return _indexToCharacter;
  }
